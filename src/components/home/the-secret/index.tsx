...
function Index() {
  ...
  return (
    <div>
      <div
        className="flex flex-row items-center justify-center space-x-2 py-6 cursor-pointer"
        onClick={toggleSecret}
      >
        <span>
          {isOpen ? (
            <IoIosArrowUp className="text-lg text-blue-600" />
          ) : (
      ...
      {isOpen && (
        <BlurFade inView className="bg-blue-50 shadow-sm shadow-gray-200 pb-6">
            ...
            <div className="flex flex-col lg:flex-row items-center justify-center mx-auto gap-x-12 my-10">
              <div className="lg:w-1/2 flex flex-col items-center justify-center space-y-4 text-gray-600">
                ...
                <p>
                  ...
                  hechas de PVC, en piezas de aproximadamente 2 metros de largo,
                ...
                <p>
                  ...
                  quedando imposibles de cerrar de nuevo. Algunas tapas se caen
                  y otras se pierden. Si el propietario las detecta a tiempo ,
                  puede intentar remacharlas, pero el daño ya está hecho, esto
                  provoca la puesta efectiva de nuevo cableado. Además, la
                  manipulación inevitablemente mancha las canaletas.
                </p>
                <p>
