...
function index() {
  return (
    <div className="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto my-14">
      <div className="grid md:grid-cols-2 gap-12">
        <div className="lg:w-3/4">
          ...
          <p className="mt-3 text-gray-600 text-sm">
            Además de la venta de materiales, ofrecemos un servicio integral de
            instalación. Contamos con un equipo de técnicos capacitados que
            aseguran un montaje profesional, respetando siempre los más altos
            estándares de calidad. Este servicio está pensado para aquellos
            clientes que prefieren dejar la instalación en manos expertas.
          </p>
          <p className="mt-5">
            <a
        ...
        <div className="space-y-6 lg:space-y-10">
          <div className="flex gap-x-5 sm:gap-x-8">
            ...
            <div className="grow">
              ...
              <p className="mt-1 text-gray-600 text-sm">
                A través de nuestra página web, los clientes pueden adquirir
                nuestras canaletas y otros componentes, ideal para quienes
                prefieren encargarse de la instalación por su cuenta.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-x-5 sm:gap-x-8">
            ...
            <div className="grow">
              ...
              <p className="mt-1 text-gray-600 text-sm">
                Si prefieres un trabajo completo y sin preocupaciones, nuestro
                equipo especializado se encarga de todo. Desde el estudio
                personalizado hasta la instalación, garantizamos un resultado de
                alta calidad y satisfacción.
              </p>
            </div>
          </div>
          ...
          <div className="flex gap-x-5 sm:gap-x-8">
            ...
            <div className="grow">
              <h3 className="text-base sm:text-md font-semibold text-gray-800">
                Estudio Personalizado y Render 3D
              </h3>
              <p className="mt-1 text-gray-600 text-sm">
                Ofrecemos un análisis detallado de las necesidades de tu
                proyecto, acompañado de un render que te permitirá visualizar el
                trabajo antes de comenzar. Además, proporcionamos un presupuesto
                sin compromiso.
              </p>
            </div>
          </div>
