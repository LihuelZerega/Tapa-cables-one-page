          ...
          >
            <div className="flex lg:flex-1">
              <a href="/" className="-m-1.5 p-1.5">
                ...
                <h1 className="text-2xl font-bold text-[#262084]">TAPACABLES</h1>
              </a>
            </div>
            ...
            <div className="hidden lg:flex items-center space-x-6 lg:justify-end">
              ...
              <a
                href="#contacto"
                className="w-fit rounded-sm bg-[#262084] px-3 py-3 text-base text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#262084] transition-colors"
              >
        ...
        <div className="mx-auto  py-32 sm:py-48 lg:py-44 2xl:py-48">
          <div className="relative z-10 ">
            ...
            <div className="mt-10 flex items-center lg:items-start justify-center lg:justify-start gap-x-6">
              <a
                href="#Producto"
                className="block lg:hidden rounded-sm bg-[#262084] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#262084] transition"
              >
                Descubre cómo
              </a>
              <a
                href="#producto"
                className="hidden lg:block rounded-sm bg-[#262084] px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#262084] transition"
              >
                Descubre cómo
              </a>
            </div>
        ...
        <div className="relative mx-auto max-w-5xl px-6 py-24">
          <div className="relative z-10 mx-auto max-w-3xl text-center">
            <h1 className="font-bold tracking-tight text-[33px] leading-tight md:text-5xl lg:text-6xl text-gray-800">
              ...
              <span className="text-[#262084]">Tapa</span>ndo{" "}
              <span className="text-[#262084]">cables</span>.
            </h1>
