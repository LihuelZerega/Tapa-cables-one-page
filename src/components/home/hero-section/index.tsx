        ...
        <div className="mx-auto  py-32 sm:py-48 lg:py-44 2xl:py-48">
          <div className="relative z-10 ">
            ...
            <div className="mt-10 flex items-center lg:items-start justify-center lg:justify-start gap-x-6">
              ...
              <a
                href="#producto"
                className="hidden lg:blockrounded-sm bg-blue-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 transition"
              >
                ¿Te ayudamos?
              </a>
            </div>
